...
//Name: Mr.LimboWallRedu.ma
//Last modified: Fri, Jan 14, 2022 11:05:14 AM
//Codeset: 1252
requires maya "2022";
...
fileInfo "UUID" "0BB9C1E2-421B-5300-D12D-1986F601C440";
createNode transform -s -n "persp";
	rename -uid "48271372-49F0-0ACA-8AEF-CF958246B814";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 21.612958712863282 8.8294678049950619 36.891495099851205 ;
	setAttr ".r" -type "double3" -9.3383527296023185 29.400000000000073 9.1267913825138531e-16 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "BFFE56C1-44B5-D1B8-7BD6-92A4E1E49214";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 42.936377933457322;
...
createNode transform -s -n "top";
	rename -uid "5421F935-4A74-5AAE-A57A-97B946FA61A0";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 0 1000.1 0 ;
	setAttr ".r" -type "double3" -90 0 0 ;
createNode camera -s -n "topShape" -p "top";
	rename -uid "0142734F-4B60-D596-CFFB-7FBAAAE4FB02";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".coi" 1000.1;
	setAttr ".ow" 30;
...
createNode transform -s -n "front";
	rename -uid "15EACFD3-40CA-E512-AEF0-9F816C13684A";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 0 0 1000.1 ;
createNode camera -s -n "frontShape" -p "front";
	rename -uid "9434D268-49DD-F073-8C1B-18AD9DED2CA6";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".coi" 1000.1;
	setAttr ".ow" 30;
...
createNode transform -s -n "side";
	rename -uid "5F60D14A-4207-EDFC-784A-F5839D848D7A";
	setAttr ".t" -type "double3" 1000.1 0 0 ;
	setAttr ".r" -type "double3" 0 90 0 ;
createNode camera -s -n "sideShape" -p "side";
	rename -uid "C6B623C4-4685-BEB0-EA14-7AA036B9926E";
	setAttr -k off ".v";
	setAttr ".rnd" no;
	setAttr ".coi" 1000.1;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "78AB129E-4337-AE11-97B4-33972C153D4F";
	setAttr -s 4 ".lnk";
	setAttr -s 4 ".slnk";
createNode displayLayerManager -n "layerManager";
	rename -uid "24DE5231-4B90-0F91-8D59-05B944C13545";
createNode displayLayer -n "defaultLayer";
	rename -uid "4AD6AF6F-4176-3041-6BA9-ACADE9CC464E";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "5DFB6F70-4B2A-6548-C96D-8DBC7254BA34";
createNode renderLayer -n "defaultRenderLayer";
	rename -uid "51FDF5FC-4415-82EB-8F77-A3913DAF4820";
	setAttr ".g" yes;
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "2DAD7C33-47FB-3B02-4A6F-0CBA20522F50";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "81A8D331-48EF-C8C2-0E4B-968FEF184963";
createNode lambert -n "WallMaterial";
	rename -uid "FDACA75E-4584-E4DB-526B-9CAF6F108B29";
	setAttr ".c" -type "float3" 1 0.80453551 0.53799999 ;
createNode shadingEngine -n "lambert2SG";
	rename -uid "C3289807-4CED-24D3-BF2C-339E7D55E4B5";
	setAttr ".ihi" 0;
	setAttr ".ro" yes;
createNode materialInfo -n "materialInfo1";
	rename -uid "820BEAC8-42E4-43EB-B499-33B2C54ECEAB";
createNode nodeGraphEditorInfo -n "hyperShadePrimaryNodeEditorSavedTabsInfo";
	rename -uid "30D98433-435B-F089-9174-1197AEC84AD8";
...
createNode script -n "uiConfigurationScriptNode";
	rename -uid "34727A5D-4285-48D0-197B-C1A1BD736512";
...
createNode script -n "sceneConfigurationScriptNode";
	rename -uid "0825F78B-4A80-FCE7-838A-41B992704E79";
	setAttr ".b" -type "string" "playbackOptions -min 1 -max 120 -ast 1 -aet 200 ";
	setAttr ".st" 6;
createNode aiStandardSurface -n "aiStandardSurface1";
	rename -uid "80D81C6C-49F6-C183-F963-6DA301A88955";
createNode shadingEngine -n "aiStandardSurface1SG";
	rename -uid "92FE256E-4A97-54F1-2243-B8A8B8715959";
	setAttr ".ihi" 0;
	setAttr ".ro" yes;
createNode materialInfo -n "materialInfo2";
	rename -uid "555CB7EF-4A0B-6323-954C-719E6E65E5D7";
createNode aiOptions -s -n "defaultArnoldRenderOptions";
	rename -uid "61CFEAF7-40F9-3A91-022A-6BB40B97DDC9";
	setAttr ".version" -type "string" "4.2.1";
createNode aiAOVFilter -s -n "defaultArnoldFilter";
	rename -uid "7B0EA0CF-430E-FC8C-79D7-D98F15C1ECD4";
	setAttr ".ai_translator" -type "string" "gaussian";
createNode aiAOVDriver -s -n "defaultArnoldDriver";
	rename -uid "01B56D9A-4E5C-EBA8-69F6-5FA5B2F25922";
	setAttr ".ai_translator" -type "string" "exr";
createNode aiAOVDriver -s -n "defaultArnoldDisplayDriver";
	rename -uid "07080891-49A7-76C8-077F-36A302FA6823";
	setAttr ".output_mode" 0;
	setAttr ".ai_translator" -type "string" "maya";
createNode file -n "file1";
	rename -uid "47A6001A-4733-F5BF-09A2-9EBF17EC917D";
	setAttr ".ftn" -type "string" "C:/SubstancePainter/Mr.Limbo_Wall/Mr.LimboWallRedu_Sub_WallMaterial_BaseColor.png";
	setAttr ".cs" -type "string" "sRGB";
createNode place2dTexture -n "place2dTexture1";
	rename -uid "C9FF232B-4ACC-3AA6-18D3-D18C6BD87996";
createNode file -n "file2";
	rename -uid "2DA5E01C-49A3-0069-E263-AA822278BDC2";
	setAttr ".ftn" -type "string" "C:/SubstancePainter/Mr.Limbo_Wall/Mr.LimboWallRedu_Sub_WallMaterial_Height.png";
	setAttr ".cs" -type "string" "sRGB";
createNode place2dTexture -n "place2dTexture2";
	rename -uid "D7C04D95-450E-3E28-E6B9-17AC1B658379";
createNode file -n "file3";
	rename -uid "92F37976-423D-BFC7-9A5A-3DA68C7D2E11";
	setAttr ".ail" yes;
	setAttr ".cs" -type "string" "sRGB";
createNode place2dTexture -n "place2dTexture3";
	rename -uid "97378FC3-44E5-F09E-7BFF-D28B7A1E4A55";
createNode bump2d -n "bump2d1";
	rename -uid "DA1995BA-45B3-FF0D-90B9-DE985821A079";
	setAttr ".bi" 1;
	setAttr ".vc1" -type "float3" 0 5.9999998e-05 0 ;
	setAttr ".vc2" -type "float3" 9.9999997e-06 9.9999997e-06 0 ;
createNode file -n "file4";
	rename -uid "623EF9EB-4DFE-6CCD-A519-F7ACA5CFDA74";
	setAttr ".ftn" -type "string" "C:/SubstancePainter/Mr.Limbo_Wall/Mr.LimboWallRedu_Sub_WallMaterial_Normal.png";
	setAttr ".cs" -type "string" "sRGB";
createNode place2dTexture -n "place2dTexture4";
	rename -uid "2606CAE7-4E40-A989-0577-64A8072DF3D7";
select -ne :time1;
	setAttr ".o" 1;
	setAttr ".unw" 1;
...
connectAttr "WallMaterial.oc" "lambert2SG.ss";
connectAttr "lambert2SG.msg" "materialInfo1.sg";
connectAttr "WallMaterial.msg" "materialInfo1.m";
connectAttr "WallMaterial.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[0].dn"
		;
...
connectAttr "WallMaterial.msg" ":defaultShaderList1.s" -na;
