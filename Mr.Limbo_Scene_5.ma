...
//Last modified: Thu, Apr 07, 2022 08:45:30 PM
//Codeset: 1252
...
fileInfo "UUID" "C3E4555F-4008-FF47-12BD-10AE1C70E9FD";
createNode transform -s -n "persp";
	rename -uid "07F0A3FF-42BA-76CB-5FB4-2A825D9C1AB6";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 1010.4356373554573 430.84344338602745 1552.2427166309033 ;
	setAttr ".r" -type "double3" -363.33835273679387 768.99999999987278 3.0299814316531324e-16 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "CE9A0B9D-4BA2-CC02-C92A-429D0719B831";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 2183.7858384194769;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".tp" -type "double3" 1231.422212372652 258.35627278744124 -361.04821439429224 ;
...
createNode transform -n "camera1";
	...
	setAttr ".t" -type "double3" 1490.65088933125 220.99656506877849 1099.6471476402694 ;
	setAttr ".r" -type "double3" 3.0000000000000049 22.400000000000468 1.0750393185658633e-16 ;
createNode camera -n "cameraShape1" -p "camera1";
	...
	setAttr ".ff" 0;
	setAttr ".ovr" 1.3;
	setAttr ".coi" 2172.4483836418212;
	setAttr ".ow" 30;
...
createNode transform -n "Wall1";
	...
	setAttr ".s" -type "double3" 422.55006361085015 89.089154792425973 58.19651799217219 ;
	setAttr ".rp" -type "double3" 0 1.6521683910049365 0 ;
	setAttr ".sp" -type "double3" 0 1.6521683910049365 0 ;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "D439DD96-408E-FEB4-E01A-469C2871721B";
	setAttr -s 115 ".lnk";
	setAttr -s 115 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "5B175292-4170-BA65-87DB-EE990DB8D2F6";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "7B9BB8A3-40D4-430D-DD1C-DEB822AF54BA";
createNode displayLayerManager -n "layerManager";
	rename -uid "90BE793E-46DC-7FAA-B639-6A919C3FA985";
createNode displayLayer -n "defaultLayer";
	rename -uid "3FF43808-45BE-4EE0-DD0E-B0A3137D84D7";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "F821D34A-4562-2023-82E2-6797885722B9";
...
createNode reference -n "TeachBot_15_UVRN";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		2 "|TeachBot_15_UV:Mr_Limbo|TeachBot_15_UV:Controls|TeachBot_15_UV:Transform_Cntr_Grp|TeachBot_15_UV:Transform_Cntr" 
		"translate" " -type \"double3\" 392.97883072577053554 0 -365.79576572029986892";
...
createNode reference -n "TV_SetsRN";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		"TV_SetsRN" 0
		"TV_SetsRN" 10
		2 "|TV_Sets:TV_Small" "translate" " -type \"double3\" 286.55314123940814852 155.14960021206158558 -151.29438102501939056"
		
		2 "|TV_Sets:TV_Small" "scale" " -type \"double3\" 16.28581104298674376 16.28581104298674376 16.28581104298674376"
		
		2 "|TV_Sets:TV_Medium" "translate" " -type \"double3\" -143.55340495281464541 166.47407020758180352 -133.83970528025866997"
		
		2 "|TV_Sets:TV_Medium" "scale" " -type \"double3\" 18.50118598560888827 18.50118598560888827 18.50118598560888827"
		
		2 "|TV_Sets:TV_Large" "translate" " -type \"double3\" 50.98826753800361899 171.50708814130109658 -135.80340608286076076"
		...
		2 "|TV_Sets:Main_TV" "translate" " -type \"double3\" 168.84991611769845576 169.29953535000882425 -135.45849178554593095"
